...
const Profile = () => {
  return (
    <section className="relative w-[40%] overflow-hidden rounded-3xl border border-white/20 bg-black/40 p-4 text-white shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur backdrop-saturate-150">
